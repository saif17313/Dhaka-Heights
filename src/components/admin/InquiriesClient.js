...
const TYPES = { contact: 'Contact Message', project_inquiry: 'Project Inquiry', callback_request: 'Callback Request', layout_request: 'Layout Request' };
