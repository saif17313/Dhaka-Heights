...
export default function ProjectsPageEditor({ initialProjectsPage }) {
  ...
  const addProject = () => {
    ...
    const project = { ...clone(source), projectId: crypto.randomUUID(), slug: `new-project-${Date.now()}`, name: 'New Project', tagline: 'NEW DHAKA HEIGHTS PROJECT', gallery: [], isVisible: false, sortOrder: (page.content.projects.length + 1) * 10 };
