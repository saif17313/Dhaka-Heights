  ...
  const body = <main style={{ marginTop: previewMode ? 0 : '80px' }}>
    ...
    <section className="project-details-body-section"><div className="container"><div className="grid-3 gap-8">
      <div className="lg-col-span-2 flex flex-col gap-8">
        ...
        <div className="project-text-block" style={{ marginTop: '45px' }}><h3 className="text-navy font-serif text-2xl font-bold mb-4" style={{ fontFamily: 'var(--font-playfair)', color: 'var(--primary-navy)' }}>{detail.overviewTitle}</h3><div className="project-description-rich text-gray-600 mb-6" style={{ fontSize: '1.05rem', lineHeight: '1.8' }} dangerouslySetInnerHTML={{ __html: project.description || '' }} /><p className="text-gray-600 leading-relaxed" style={{ fontSize: '1rem', lineHeight: '1.8' }}>{detail.secondaryDescription}</p></div>
      </div>
